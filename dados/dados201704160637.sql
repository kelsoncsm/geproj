...
CREATE TABLE `gdoks_documentos` (
  ...
  CONSTRAINT `FK_subdisciplinas` FOREIGN KEY (`id_subdisciplina`) REFERENCES `gdoks_subdisciplinas` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
...
INSERT INTO `gdoks_documentos` VALUES (9,'tetetete',2,2),(10,'Outro documento',2,2),(11,'Mais um outro',1,14),(12,'Credo',2,18),(13,'DocExame',2,15),(14,'DocExame',2,15),(15,'Candomblé',1,18),(16,'Banda Flor',1,14);
...
CREATE TABLE `gdoks_documentos_x_dependencias` (
  ...
  CONSTRAINT `FK_documentos_x_doc_dependente` FOREIGN KEY (`id_documento`) REFERENCES `gdoks_documentos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_documentos_x_doc_pai` FOREIGN KEY (`id_dependencia`) REFERENCES `gdoks_documentos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `gdoks_documentos_x_dependencias` VALUES (15,12,9),(16,10,11),(18,14,10),(22,11,9),(23,15,10),(24,15,16);
...
INSERT INTO `gdoks_projetos` VALUES (1,'Aratuba dos Palmares','ADP',2,1,1,'2017-01-02','2017-02-28',''),(2,'Duplicação da BR 119','BR119',1,2,1,'2017-01-01','2017-02-28',''),(3,'Centro','CNT',6,1,1,'2017-03-01','2017-03-31',''),(5,'Teste de Projeto 1','tetet',3,4,1,'2017-03-01','2017-04-30',''),(6,'AAATeste','AAAA1',1,1,1,'2017-03-09','2017-03-31',''),(7,'BBBTeste','BBB1',2,4,1,'2017-03-01','2017-03-31',''),(8,'CCC1','CCCC22',1,6,1,'2017-03-01','2017-03-31',''),(9,'DDDTeste','DDD',8,2,1,'2017-03-01','2017-03-29',''),(10,'Teste EEE','EEE',3,4,1,'2017-03-01','2017-03-31',''),(11,'Teste FFF','FFF',4,4,1,'2017-03-01','2017-03-31','');
...
-- Dump completed on 2017-04-16  6:37:39
